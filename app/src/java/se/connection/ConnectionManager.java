...
public class ConnectionManager {
  ...
  /**
   * Reads database details to set appropriate password
   */
  ...
  /**
   * Creates database instance to connect to database
   */
  ...
  /**
   * Closes given connection and statement
   * 
   * @param conn Connection object of database operation
   * @param stmt Statement object of database operation
   */
