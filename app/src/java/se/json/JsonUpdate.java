...
import se.controller.FileValidation;

/**
 * JsonUpdate for file validation for update of database
 */
        ...
        try{
            ...
            while(iter.hasNext()){
                ...
                if(item.isFormField()){
                    ...
                    try{
                        if(username == null || !username.equals(JWTUtility.verify(token, sharedSecret))){
                            status = "error";
           ...
           if((filenames.contains("demographics.csv") || filenames.contains("location.csv"))){
                ...
                RequestDispatcher view = request.getRequestDispatcher("JsonUpdateFiles");
